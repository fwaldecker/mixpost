...
use Inovector\Mixpost\Http\Api\Controllers\Workspace\Post\PostCommentsController as ApiPostCommentsController;
...
Route::middleware(array_merge([
    ...
    ->group(function () {
        ...
        Route::prefix('posts')->name('posts.')->middleware($editorMiddleware)->group(function () use($editorMiddleware) {
            ...
            // Comments API (create comment or reply)
            Route::post('{post}/comments', [ApiPostCommentsController::class, 'store'])->name('comments.store')->withoutMiddleware($editorMiddleware);
        });
